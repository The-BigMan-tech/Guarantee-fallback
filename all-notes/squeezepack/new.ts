...
scores.data = [0,1111111111,100000000000,24,88,998,1999,1011,1111,233,9887,0,1111111111,100000000000,24,88,998,1999,1011,1111,233,9887]
...
scores.skipCompression().push(25)
scores.push(74)
console.log('Scores today',scores.state);
...
//Even if others attempt to optimize their algorithms for sending data, they will still be constrained by the larger size of their packets. No matter how they rewrite their algorithms, they will always have to send 88 bytes, while your method only requires 32 bytes. This fundamental difference in data size will inherently make your approach faster and more efficient.