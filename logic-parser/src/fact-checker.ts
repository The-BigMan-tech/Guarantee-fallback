...
export class Doc {//I named it Doc instead of Document to avoid ambiguity with the default Document class which is for the DOM
    ...
    private factCheckerCache:LRUCache<string,string> = new LRUCache({max:100});
    ...
    public findFirstFact(record: Rec, args:PatternedAtoms,byMembership:boolean=false):false | Atoms {
