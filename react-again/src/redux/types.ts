...
export type StrictTabsType = 'Recent' | 'Desktop'|'Downloads' | 'Documents' | 'Pictures' | 'Music' |'Videos';
export type AllTabTypes = 'Home' | 'Desktop'|'Downloads' | 'Documents' | 'Pictures' | 'Music' |'Videos'
export type invalidationData = {tabName:AllTabTypes}
