...
const shouldLogToFile:boolean = true;//be toggling this whenever you want to monitor the app vs when you want to use the app at its best perf to test its functionality
