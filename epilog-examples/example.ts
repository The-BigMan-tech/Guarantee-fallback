...
console.info(await doc.isItAFact('friends',['philip','john']));//outputs false because its not a direct fact
console.info(await rules.areFriends(doc,['ada','billy']));//outputs true out of inference
